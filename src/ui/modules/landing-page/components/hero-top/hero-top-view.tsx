    ...
    <Container className="relative pt-40 overflow-hidden pb-52">
        <div className="w-full max-w-2xl space-y-5">
            ...
            <Typography
                ...
                className="max-w-xl"
            >
                Ici, on se prend pas la tete, mais on code des betes!
                Rejoins notre tribu de singes codeurs, partage tes projets
                les plus fous et fais-toi de nouvaeux amis developpeurs
            </Typography>
        ...
        <Image
            ...
            alt="Illustration d'une fusé pour materialiser l'évolution du level des developpeurs front-end"
            width={811}
            height={596}
